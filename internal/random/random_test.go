...
func TestSequencePrefixesAndIncrements(t *testing.T) {
	t.Parallel()
	s := NewSequence("req")
...
func TestSequenceDefaultPrefix(t *testing.T) {
	t.Parallel()
	s := NewSequence("")
...
func TestSequenceConcurrentNextProducesUniqueIds(t *testing.T) {
	t.Parallel()
	s := NewSequence("c")
	const goroutines = 16
